	...
	useEffect(() => {
		const fetchBlogPosts = async () => {
			const { posts, postsConnection } = await request(
				...
				`
			{
				posts (where: {tags_contains_some: "Wisata"}, orderBy: date_DESC, first: ${postsPerPage}, skip: ${
      ...
      <Layout preview={preview}>
               <Head
                   ...
                   >
                     ...
                     <link rel="alternate" href="https://studiofrugreenproject.com/wisata" hreflang="id-ID" />
