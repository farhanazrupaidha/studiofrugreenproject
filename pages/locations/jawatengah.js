	...
	useEffect(() => {
		const fetchBlogPosts = async () => {
			const { posts, postsConnection } = await request(
				...
				`
			{
				posts (where: {_search: "jawa tengah"}, locales: id, orderBy: date_DESC, first: ${postsPerPage}, skip: ${
    ...
    <>
      <Layout preview={preview}>
               <Head
                     ...
                     defaultTitle="Jawa Tengah. | Ensiklopedia Alam"
                   >
                     ...
                     <meta name="twitter:title" content="Jawa Tengah. | Ensiklopedia Alam" />
