	...
	useEffect(() => {
		const fetchBlogPosts = async () => {
			const { posts, postsConnection } = await request(
				...
				`
			{
				posts (where: {_search: "jawa barat"}, locales: id, orderBy: date_DESC, first: ${postsPerPage}, skip: ${
    ...
    <>
      <Layout preview={preview}>
               <Head
                   ...
                   >
                     <title>Jawa Barat. | Ensiklopedia Alam</title>
                    ...
                    <meta name="author" content="Studiofru | https://wiwit.net/" />
                     ...
                     <meta property="og:url" content="https://wiwit.net/locations/jawabarat" />
                     <meta property="og:title" content="Jawa Barat. | Ensiklopedia Alam" />
                     ...
                     <meta name="twitter:title" content="Jawa Barat. | Ensiklopedia Alam" />
