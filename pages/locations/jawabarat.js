	...
	useEffect(() => {
		const fetchBlogPosts = async () => {
			const { posts, postsConnection } = await request(
				...
				`
			{
				posts (locales: ${formattedLocale}, where: {_search: "jawa barat"}, orderBy: date_DESC, first: ${postsPerPage}, skip: ${
      ...
      <Layout preview={preview}>
               <Head
                   ...
                   >
                     ...
                     <meta property="og:description" content="Jelajah ensiklopedia dan berbagai informasi mengenai flora dan fauna di wilayah Jawa Bara" />
