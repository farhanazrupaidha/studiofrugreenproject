	...
	useEffect(() => {
		const fetchBlogPosts = async () => {
			const { posts, postsConnection } = await request(
				...
				`
			{
				posts (where: {tags_contains_some: "Pengetahuan"}, orderBy: date_DESC, first: ${postsPerPage}, skip: ${
      ...
      <Layout preview={preview}>
               <Head
                   ...
                   >
                     ...
                     <link rel="alternate" href="https://studiofrugreenproject.com/pengetahuan" hreflang="id-ID" />
                     <link rel="alternate" href="https://studiofrugreenproject.com/en/knowledge" hreflang="en-US" />
                     <link rel="alternate" href="https://studiofrugreenproject.com/en/knowledge" hreflang="x-default" /> 
                     <meta name="author" content="Studiofru | Green Project" /> 
                     <meta property="image" content="/images/tanah.jpg" />
                     <meta property="og:url" content="https://studiofrugreenproject.com/pengetahuan" />
                     <meta property="og:title" content="Studiofru | Green Project - Pengetahuan" />
                     <meta property="og:description" content="Jelajah ensiklopedia dan berbagai informasi mengenai pengetahuan lingkungan." />
                     <meta property="og:site_name" content="Studiofru | Green Project - Pengetahuan" />
                     <meta property="og:image" content="/images/tanah.jpgttps://www.studiofrugreenproject.com/images/tanah.jpg" />
                     <meta name="og:type" content="website" />
                     <meta name="twitter:site" content="@studiofruworks" />
                     <meta name="twitter:title" content="Studiofru | Green Project - Pengetahuan" />
