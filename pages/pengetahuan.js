	...
	useEffect(() => {
		const fetchBlogPosts = async () => {
			const { posts, postsConnection } = await request(
				...
				`
			{
				posts (where: {_search: "pengetahuan"}, locales: id, orderBy: date_DESC, first: ${postsPerPage}, skip: ${
      ...
      <Layout preview={preview}>
               <Head
                   ...
                   >
                     ...
                     <meta property="og:title" content="Pengetahuan. | Ensiklopedia Alam" />
                     ...
                     <meta name="twitter:title" content="Pengetahuan. | Ensiklopedia Alam" />
