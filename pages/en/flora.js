	...
	useEffect(() => {
		const fetchBlogPosts = async () => {
			const { posts, postsConnection } = await request(
				...
				`
			{
				posts (locales: en, where: {tags_contains_some: "Flora"}, orderBy: date_DESC, first: ${postsPerPage}, skip: ${
    ...
    <>
      <Layout preview={preview}>
               <Head
                   ...
                   >
                     <title>Studiofru | Green Project - Flora in Indonesia</title>
                     <meta name="description" content="Explore the encyclopedia and various informations regarding the naming identity, origin, history and benefits of various plants in Indonesia." />
                     <meta name="keywords" content="studiofru, encyclopedia, nature encyclopedia, flora in Indonesia encyclopedia, plantations, agriculture, Indonesian flora" />
