	...
	useEffect(() => {
		const fetchBlogPosts = async () => {
			const { posts, postsConnection } = await request(
				...
				`
			{
				posts (locales: en, where: {tags_contains_some: "Pengetahuan"}, orderBy: date_DESC, first: ${postsPerPage}, skip: ${
      ...
      <Layout preview={preview}>
               <Head
                   ...
                   >
                     ...
                     <link rel="alternate" href="https://studiofrugreenproject.com/knowledge" hreflang="id-ID" />
