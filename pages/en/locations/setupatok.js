	...
	useEffect(() => {
		const fetchBlogPosts = async () => {
			const { posts, postsConnection } = await request(
				...
				`
			{
				posts (locales: en, where: {tags_contains_some: "Setu Patok"}, orderBy: date_DESC, first: ${postsPerPage}, skip: ${
    ...
    <>
      <Layout preview={preview}>
               <Head
                   ...
                   >
                     <title>Studiofru | Green Project - Flora and Fauna in lake Setu Patok Mundu Cirebon</title>
                     <meta name="description" content="Explore encyclopedias and various informations about flora and fauna in lake Setu Patok Mundu Cirebon." />
                     <meta name="keywords" content="studiofru, green project, studiofru green project, setu patok encyclopedia, animals in Setu Patok, plants in Bali, flora in Setu Patok, farming in Setu Patok, livestock in Setu Patok " />
                     ...
                     <meta property="og:url" content="https://studiofrugreenproject.com/en/locations/setupatok" />
                     <meta property="og:title" content="Studiofru | Flora and Fauna in lake Setu Patok Mundu Cirebon" />
                     <meta property="og:description" content="Explore encyclopedias and various information about flora and fauna in lake Setu Patok Mundu Cirebon." />
                     <meta property="og:site_name" content="Studiofru | Flora and Fauna in lake Setu Patok Mundu Cirebon" />
                     <meta property="og:image" content="https://www.studiofrugreenproject.com/images/tanah.jpg" />
                     <meta name="og:type" content="website" />
                     <meta name="twitter:site" content="@studiofruworks" />
                     <meta name="twitter:title" content="Studiofru | Flora and Fauna in lake Setu Patok Mundu Cirebon" />
        ...
        <Container>
          <Intro />
            <h2 className="mb-10 text-6xl md:text-7xl font-bold tracking-tighter leading-tight">
              Setu Patok Lake Conservation Area
            </h2>
          <Hero />
